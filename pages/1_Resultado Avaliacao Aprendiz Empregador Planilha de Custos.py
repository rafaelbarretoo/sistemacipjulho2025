...
st.markdown("""
    <div class="main-header">
        <h1 style='margin:0;'>Projeto  Automação Aprendiz-Empregador - Planilha de Custos </h1>
        <p style='margin:0; font-size:1.1rem;'>SUPEX - Gerência Jurídica e Compliance e DPO - Fabrício Canonaco</p>
    </div>
""", unsafe_allow_html=True)
